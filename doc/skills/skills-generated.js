...
skill19 = {
  parent: skill0,
  innerHTML: skillInfo("Athletics", "Str", true, false, true, true, true, true, false, false, false),
  stackChildren: true
}

skill20 = {
  parent: skill19,
  innerHTML: skillInfo("Acrobatics", "Dex", true, false, true, true, true, true, false, false, false),
  stackChildren: true
}

skill21 = {
  parent: skill19,
  innerHTML: skillInfo("Climb", "Str", true, false, true, true, true, true, false, false, false),
  stackChildren: true
}

skill22 = {
  parent: skill19,
  innerHTML: skillInfo("Swim", "Str", true, false, true, true, true, true, false, false, false),
  stackChildren: true
}

skill23 = {
  parent: skill19,
  innerHTML: skillInfo("Fly", "Dex", true, true, true, false, true, false, false, false, true),
  stackChildren: true
}

chart_config = [config, root, skill0, skill1, skill2, skill3, skill4, skill5, skill6, skill7, skill8, skill9, skill10, skill11, skill12, skill13, skill14, skill15, skill16, skill17, skill18, skill19, skill20, skill21, skill22, skill23, ]
